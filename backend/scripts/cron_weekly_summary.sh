...
# (cobertura del log crudo) y settle_live_odds.py (intenta liquidar partidos
# ya jugados y calcula ROI acumulado si hay apuestas sentenciadas). Todo
# queda en un único archivo legible que se sobreescribe cada semana.
